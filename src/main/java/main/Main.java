...
public class Main {
	...
	public static void main(String[] args) {
		...
		int i = 0;
		System.out.println("G�n�ration de la base...");
		...
		datas.generateBase();
		System.out.println("G�n�ration de la base OK");
		...
		for (User user : listUser) {
			...
			System.out.println("Nombre de Tweet �crit par " + user.getName() + " = " + totalTweet );
